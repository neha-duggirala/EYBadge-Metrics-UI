...
export default new Vuex.Store({
  state: {
    ...
    // ],
    developerKpiObj: { date: "", testCoverage: "", codeSmellPercent: "", codeQualityPercent: "", kloc: "", throughput: "" },
    outOfBoxObj: {date: "", ideasToEnhanceTheCompany: "", ideasToEnhanceTheProject: ""},
    NewEmployeeObj:{
      developerKpiDto: [],
      employeeId:"",
      employeeName:"",
    ...
    mutations: {
      ...
      setSelectedEmployee(state, data) {
        ...
        console.log("Store",state.EmployeeObj.employeeId);
